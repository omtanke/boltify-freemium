				...
				<HeaderLeft className='flex-col items-start!'>
					<Breadcrumb
						list={[
							...
							{ ...pages.documentation.baseComponent.subPages.blockquote },
						]}
					/>
					<div className='flex items-center gap-4 py-8'>
						<Icon
							icon={pages.documentation.baseComponent.subPages.blockquote.icon}
							size='text-4xl'
						/>
						<span className='text-4xl font-bold'>
							{pages.documentation.baseComponent.subPages.blockquote.text}
						</span>
					</div>
				</HeaderLeft>
			</Header>
