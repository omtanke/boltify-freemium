...
import containerSource from '@/components/layout/Container.tsx?raw'; // eslint-disable-line import/extensions
				...
				<HeaderLeft className='flex-col items-start!'>
					<Breadcrumb
						list={[
							...
							{ ...pages.documentation.layout.subPages.container },
						]}
					/>
					<div className='flex items-center gap-4 py-8'>
						<Icon
							icon={pages.documentation.layout.subPages.container.icon}
							size='text-4xl'
						/>
						<span className='text-4xl font-bold'>
							{pages.documentation.layout.subPages.container.text}
						</span>
					</div>
				</HeaderLeft>
			</Header>
			<Container>
				<div className='flex flex-col gap-4'>
					<div className='text-2xl text-zinc-500'>
						You can use the carefully prepared components and examples prepared with
						these components to meet your project's needs here as you wish.
					</div>
					...
					<div className='flex gap-4'>
						...
						<div className='flex h-[50rem] w-full flex-col gap-2 rounded-2xl border-2 border-dashed border-zinc-500/50 p-2'>
							...
							<div className='flex h-full animate-pulse flex-col rounded-xl border-2 border-dashed border-amber-500/50 p-2'>
								<div>Container</div>
							</div>
						</div>
					</div>
					...
					<Card>
						...
						<CardBody>
							<MdViewer code={extractSnippetUtil(containerSource, 'interface')} />
						</CardBody>
					</Card>
				</div>
			</Container>
