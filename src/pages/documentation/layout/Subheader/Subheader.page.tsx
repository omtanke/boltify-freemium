...
import subheaderSource from '@/components/layout/Subheader.tsx?raw'; // eslint-disable-line import/extensions
				...
				<HeaderLeft className='flex-col items-start!'>
					<Breadcrumb
						list={[
							...
							{ ...pages.documentation.layout.subPages.subheader },
						]}
					/>
					<div className='flex items-center gap-4 py-8'>
						<Icon
							icon={pages.documentation.layout.subPages.subheader.icon}
							size='text-4xl'
						/>
						<span className='text-4xl font-bold'>
							{pages.documentation.layout.subPages.subheader.text}
						</span>
					</div>
				</HeaderLeft>
			</Header>
			<Container>
				<div className='flex flex-col gap-4'>
					...
					<Card>
						...
						<CardBody>
							<MdViewer code={extractSnippetUtil(subheaderSource, 'interface')} />
						</CardBody>
					</Card>
				</div>
			</Container>
