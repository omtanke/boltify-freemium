...
import wrapperSource from '@/components/layout/Wrapper.tsx?raw'; // eslint-disable-line import/extensions
				...
				<HeaderLeft className='flex-col items-start!'>
					<Breadcrumb
						list={[
							...
							{ ...pages.documentation.layout.subPages.wrapper },
						]}
					/>
					<div className='flex items-center gap-4 py-8'>
						<Icon
							icon={pages.documentation.layout.subPages.wrapper.icon}
							size='text-4xl'
						/>
						<span className='text-4xl font-bold'>
							{pages.documentation.layout.subPages.wrapper.text}
						</span>
					</div>
				</HeaderLeft>
			</Header>
			<Container>
				<div className='flex flex-col gap-4'>
					<div className='text-2xl text-zinc-500'>
						Generally, you can use it in layouts such as DefaultLayout, but you can use
						it however you want as long as you preserve the structure in the scheme.
					</div>
					...
					<div className='flex gap-4'>
						...
						<div className='flex h-[50rem] w-full animate-pulse flex-col gap-2 rounded-2xl border-2 border-dashed border-zinc-500/50 p-2'>
							Wrapper
					...
					<Card>
						...
						<CardBody>
							<MdViewer code={extractSnippetUtil(wrapperSource, 'interface')} />
						</CardBody>
					</Card>
				</div>
			</Container>
