		...
		<>
			<Header>
				<HeaderLeft className='flex-col items-start!'>
					<Breadcrumb list={[{ ...pages.documentation.gettingStarted }]} />
					<div className='flex items-center gap-4 py-8'>
						<Icon icon={pages.documentation.gettingStarted.icon} size='text-4xl' />
						<span className='text-4xl font-bold'>
							{pages.documentation.gettingStarted.text}
						</span>
					</div>
				</HeaderLeft>
			</Header>
