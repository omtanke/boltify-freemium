...
import textareaSource from '@/components/form/Textarea.tsx?raw'; // eslint-disable-line import/extensions
				...
				<HeaderLeft className='flex-col items-start!'>
					<Breadcrumb
						list={[
							...
							{ ...pages.documentation.forms.subPages.textarea },
						]}
					/>
					<div className='flex items-center gap-4 py-8'>
						<Icon
							icon={pages.documentation.forms.subPages.textarea.icon}
							size='text-4xl'
						/>
						<span className='text-4xl font-bold'>
							{pages.documentation.forms.subPages.textarea.text}
						</span>
					</div>
				</HeaderLeft>
			</Header>
			<Container>
				<div className='flex flex-col gap-8'>
					...
					<Card>
						<CardHeader>
							<CardHeaderChild>
								...
								<CardSubTitle>Textarea</CardSubTitle>
							</CardHeaderChild>
						</CardHeader>
						<CardBody>
					...
					<Card>
						...
						<CardBody>
							<MdViewer code={extractSnippetUtil(textareaSource, 'interface')} />
						</CardBody>
					</Card>
				</div>
			</Container>
