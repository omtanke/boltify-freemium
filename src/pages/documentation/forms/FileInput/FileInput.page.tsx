...
import fileInputSource from '@/components/form/FileInput.tsx?raw'; // eslint-disable-line import/extensions
				...
				<HeaderLeft className='flex-col items-start!'>
					<Breadcrumb
						list={[
							...
							{ ...pages.documentation.forms.subPages.fileInput },
						]}
					/>
					<div className='flex items-center gap-4 py-8'>
						<Icon
							icon={pages.documentation.forms.subPages.fileInput.icon}
							size='text-4xl'
						/>
						<span className='text-4xl font-bold'>
							{pages.documentation.forms.subPages.fileInput.text}
						</span>
					</div>
				</HeaderLeft>
			</Header>
			<Container>
				<div className='flex flex-col gap-8'>
						...
						<CardBody>
							...
							<PreviewComponent inIFrame={false} mdFile={labelMd as RequestInfo}>
								<div className='max-w-sm'>
									<FileInput name='basic' label='This is label' />
								</div>
							</PreviewComponent>
						</CardBody>
					</Card>
					<Card>
						<CardHeader>
							<CardHeaderChild>
								...
								<CardSubTitle>FileInput</CardSubTitle>
							</CardHeaderChild>
						</CardHeader>
							...
							<Card>
								...
								<CardBody>
									...
									<PreviewComponent
										...
										<div className='max-w-sm'>
											<FileInput name='gray' variant='gray' label='Gray' />
										</div>
									</PreviewComponent>
								</CardBody>
							</Card>
							<Card>
								...
								<CardBody>
									...
									<PreviewComponent
										...
										<div className='max-w-sm'>
											<FileInput name='solid' variant='solid' label='Solid' />
										</div>
									</PreviewComponent>
								</CardBody>
							</Card>
						...
						<CardBody>
							...
							<PreviewComponent inIFrame={false} mdFile={dimensionMd as RequestInfo}>
								<div className='flex flex-col gap-4'>
									<div className='max-w-sm'>
										<FileInput name='small' dimension='sm' />
									</div>
									<div className='max-w-sm'>
										<FileInput name='default' />
									</div>
									<div className='max-w-sm'>
										<FileInput name='large' dimension='lg' />
									</div>
								</div>
							</PreviewComponent>
						</CardBody>
								...
								<CardBody>
									...
									<PreviewComponent
										...
										<div className='w-full space-y-2 sm:inline-flex sm:items-center sm:space-y-0 sm:space-x-3 [&>*]:my-0'>
											<Label htmlFor='helperLine' className='w-auto!'>
												This is label
											</Label>
											<div className='max-w-sm'>
												<FileInput
					...
					<Card>
						...
						<CardBody>
							<MdViewer code={extractSnippetUtil(fileInputSource, 'interface')} />
						</CardBody>
					</Card>
				</div>
			</Container>
